...
void AppClass::Display(void)
{
	...
	matrix4 m4Model = m_pMeshMngr->GetModelMatrix("Steve") * glm::translate(m_v3Center1);	// Sets this to Steve's location
	matrix4 m4View = m_pCameraMngr->GetViewMatrix();
	matrix4 m4Projection = m_pCameraMngr->GetProjectionMatrix();

	m_pSphere1->Render(m4Projection, m4View, m4Model);

	 m4Model = m_pMeshMngr->GetModelMatrix("Creeper") * glm::translate(m_v3Center2);	// Sets this to Steve's location
