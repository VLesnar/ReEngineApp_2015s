...
{
	super::InitWindow("Lesnar, Veronica - 3D Transformations");
...
void AppClass::InitVariables(void)
{
	...
	m_pCylinder->GenerateCylinder(0.5f, 1.0f, 10, REBLUE);
...
void AppClass::Update(void)
{
	...
	m_m4Cube = glm::scale(m_m4Cube, vector3(2.0f, 2.0f, 1.0f));
	m_m4Cylinder = glm::scale(m_m4Cylinder, vector3(2.0f, 1.0f, 0.0f));
